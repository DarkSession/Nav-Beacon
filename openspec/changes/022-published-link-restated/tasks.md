...
- [ ] 3.2 Verify the publication's own bound still holds: a Commander who leaves the workspace
...
- [ ] 3.3 Verify the restoration's own bound, which is the one this change adds: publish a link
...
- [ ] 4.1 Add a journey to `e2e/build-link.spec.ts`, beside the other journeys the
      ...
      (022/FR-001).
- [ ] 4.2 Register the change in `e2e/coverage-ledger.ts`: add `022-published-link-restated` to
